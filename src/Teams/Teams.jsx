...
function Teams() {
  const slides = [
    ...
    },
    {
      ...
      position: 'CRM',
      description:
        "NMiss Yogita Thakur, a graduate of St. Paul Institute of Professional Studies, Indore, is a dedicated professional with a keen eye for detail and a passion for continuous learning. Her customized approach to tasks has proven invaluable at Word Dealers Pvt Ltd, where she has excelled for over a year. With exceptional research and communication skills, Yogita has successfully expanded the company's market reach. Her expertise in customer relationship management makes her uniquely qualified to guide and support beauty pageant contestants, understanding their specific needs and aspirations.",
      image: image,
    },
  ]
